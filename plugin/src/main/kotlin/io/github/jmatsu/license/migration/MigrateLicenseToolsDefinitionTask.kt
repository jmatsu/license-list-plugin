    ...
    constructor(
        ...
        object Executor {
            operator fun invoke(
                ...
                val keyToPlainLicenseMap =
                    keyToToolsLicenseMap
                        .filterNot {
                        ...
                        .mapValues { it.value.map { it.second }.distinctBy { it.key.value } }

                val definitions =
                    keyToToolsLicenseMap
                        .filterNot { it.first in ignoreKeys }
                        .map { (key, l) ->
                ...
                val licenses =
                    keyToPlainLicenseMap.values
                        .flatten()
                        .distinctBy { it.key.value }
